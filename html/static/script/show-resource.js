...
$(document).ready(function () {
    ...
    $('#login-time-range-filters').on('clear.daterangepicker', function (ev, picker) {
        //do something, like clearing an input
        $('#login-time-range-filters').val('');
        loginTimeClear = true;
    });
    $('#login-time-range-filters').on('apply.daterangepicker', function (ev, picker) {
        loginTimeClear = false;
    });
    $('#login-time-range-filters').on('cancel.daterangepicker', function (ev, picker) {
        if (loginTimeClear) {
            $('#login-time-range-filters').val('');
        }
    });
    $('#login-time-range-filters').on('outsideClick.daterangepicker', function (ev, picker) {
        if (loginTimeClear) {
            $('#login-time-range-filters').val('');
        }
    });
    ...
    $('#assign-time-range-filters').on('clear.daterangepicker', function (ev, picker) {
        //do something, like clearing an input
        $('#assign-time-range-filters').val('');
        assignTimeClear = true;
    });
    $('#assign-time-range-filters').on('apply.daterangepicker', function (ev, picker) {
        assignTimeClear = false;
    });
    $('#assign-time-range-filters').on('cancel.daterangepicker', function (ev, picker) {
        if (assignTimeClear) {
            $('#assign-time-range-filters').val('');
        }
    });
